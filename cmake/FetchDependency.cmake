...
macro( fetch_dependency target url tag  )
  ...
  if (NOT TARGET ${target})
    find_file(${target}_project ${target}.project PATHS ${PROJECT_SOURCE_DIR}/../${target} ${PROJECT_SOURCE_DIR}/../../${target}
    ...
    if (NOT ${target}_project)
        ...
        message( "${BoldRed} -- ${PROJECT_SOURCE_DIR} -- ${CMAKE_CURRENT_LIST_FILE} Using ${target} downloaded from git, saved at: ${${target}_SOURCE_DIR}${ColourReset}" )
    else()
        get_filename_component( dir ${${target}_project} DIRECTORY )
        set(${target}_SOURCE_DIR ${dir})
        message( "${BoldGreen} -- ${PROJECT_SOURCE_DIR} --  ${CMAKE_CURRENT_LIST_FILE} Using ${target} on the local disk at: ${${target}_SOURCE_DIR}${ColourReset}" )
